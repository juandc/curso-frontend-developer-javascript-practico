...
logoMenu.addEventListener('click', toggleMenuMovile);
...
function toggleShoppingCart() {
    const isMenuMovile = menuMovil.classList.contains('inactive');
    const isPrductDetail = productDetailContainer.classList.contains('inactive');
